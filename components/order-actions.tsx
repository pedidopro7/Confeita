...
export function OrderActions({ id, status, fulfillmentType = 'pickup' }: { id: string; status: string; fulfillmentType?: string }) {
  ...
  return <div className="space-y-2">
    ...
    {status === 'awaiting_deposit' && <div className="rounded-2xl bg-warning/10 px-3 py-2.5 text-[10px] font-bold text-warning">Aguardando o sinal. Registre o recebimento acima; ao atingir o valor mínimo, a Confeita confirma e reserva os ingredientes automaticamente.</div>}
